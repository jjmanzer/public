...
class yc_config_openconfig_spanning_tree__stp_global_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__enabled_protocol','__bridge_assurance','__etherchannel_misconfig_guard','__bpduguard_timeout_recovery','__loop_guard','__bpdu_guard','__bpdu_filter',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__enabled_protocol = YANGDynClass(base=TypedListType(allowed_type=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'RAPID_PVST': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'RSTP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'MSTP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:RAPID_PVST': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:RSTP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:MSTP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},)), is_leaf=False, yang_name="enabled-protocol", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'global', u'config']
...
brought back into service.
  ...
  _pyangbind_elements = {'enabled_protocol': enabled_protocol, 'bridge_assurance': bridge_assurance, 'etherchannel_misconfig_guard': etherchannel_misconfig_guard, 'bpduguard_timeout_recovery': bpduguard_timeout_recovery, 'loop_guard': loop_guard, 'bpdu_guard': bpdu_guard, 'bpdu_filter': bpdu_filter, }
...
class yc_config_openconfig_spanning_tree__stp_rstp_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__hello_time','__max_age','__forwarding_delay','__hold_count','__bridge_priority',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__max_age = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'6..40']}), is_leaf=True, yang_name="max-age", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__bridge_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="bridge-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=True)
    self.__hold_count = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), default=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8)(6), is_leaf=True, yang_name="hold-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__hello_time = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), is_leaf=True, yang_name="hello-time", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__forwarding_delay = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'4..30']}), is_leaf=True, yang_name="forwarding-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
...
configuration messages by designated ports
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), is_leaf=True, yang_name="hello-time", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hello_time must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), is_leaf=True, yang_name="hello-time", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)""",
        })
...
bridge when it is the root bridge
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'6..40']}), is_leaf=True, yang_name="max-age", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """max_age must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'6..40']}), is_leaf=True, yang_name="max-age", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)""",
        })
...
designated ports to forwarding
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'4..30']}), is_leaf=True, yang_name="forwarding-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """forwarding_delay must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'4..30']}), is_leaf=True, yang_name="forwarding-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)""",
        })
...
switch can send from an interface
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), default=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8)(6), is_leaf=True, yang_name="hold-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """hold_count must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), default=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8)(6), is_leaf=True, yang_name="hold-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)""",
        })
  ...
  def _set_bridge_priority(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="bridge-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="bridge-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'hello_time': hello_time, 'max_age': max_age, 'forwarding_delay': forwarding_delay, 'hold_count': hold_count, 'bridge_priority': bridge_priority, }
...
class yc_state_openconfig_spanning_tree__stp_rstp_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__hello_time','__max_age','__forwarding_delay','__hold_count','__bridge_priority','__bridge_address','__designated_root_priority','__designated_root_address','__root_port','__root_cost','__hold_time','__topology_changes','__time_since_topology_change',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__bridge_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    self.__hold_count = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), default=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8)(6), is_leaf=True, yang_name="hold-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=False)
    self.__forwarding_delay = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'4..30']}), is_leaf=True, yang_name="forwarding-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=False)
    self.__designated_root_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-root-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    self.__designated_root_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="designated-root-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=False)
    ...
    self.__time_since_topology_change = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="time-since-topology-change", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-types:timeticks64', is_config=False)
...
assigned to the bridge
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """bridge_address must be of a type compatible with oc-yang:mac-address""",
          'defined-type': "oc-yang:mac-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)""",
        })
...
as executed by this node
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-root-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """designated_root_address must be of a type compatible with oc-yang:mac-address""",
          'defined-type': "oc-yang:mac-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-root-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)""",
        })
...
reset or initialized
  ...
  def _get_time_since_topology_change(self):
    """
    Getter method for time_since_topology_change, mapped from YANG variable /stp/rstp/state/time_since_topology_change (oc-types:timeticks64)

    YANG Description: The time (in hundredths of a second) since the
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
    """
    return self.__time_since_topology_change
      
  def _set_time_since_topology_change(self, v, load=False):
    """
    Setter method for time_since_topology_change, mapped from YANG variable /stp/rstp/state/time_since_topology_change (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_time_since_topology_change is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_time_since_topology_change() directly.
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="time-since-topology-change", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-types:timeticks64', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """time_since_topology_change must be of a type compatible with oc-types:timeticks64""",
          'defined-type': "oc-types:timeticks64",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="time-since-topology-change", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-types:timeticks64', is_config=False)""",
        })

    self.__time_since_topology_change = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_time_since_topology_change(self):
    self.__time_since_topology_change = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range':  ['0..18446744073709551615']}, int_size=64), is_leaf=True, yang_name="time-since-topology-change", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-types:timeticks64', is_config=False)
  ...
  time_since_topology_change = __builtin__.property(_get_time_since_topology_change)


  _pyangbind_elements = {'hello_time': hello_time, 'max_age': max_age, 'forwarding_delay': forwarding_delay, 'hold_count': hold_count, 'bridge_priority': bridge_priority, 'bridge_address': bridge_address, 'designated_root_priority': designated_root_priority, 'designated_root_address': designated_root_address, 'root_port': root_port, 'root_cost': root_cost, 'hold_time': hold_time, 'topology_changes': topology_changes, 'time_since_topology_change': time_since_topology_change, }
...
class yc_config_openconfig_spanning_tree__stp_rstp_interfaces_interface_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__cost','__port_priority',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__port_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=True)
    ...
    self.__name = YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rstp', u'interfaces', u'interface', u'config']
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with oc-if:base-interface-ref""",
          'defined-type': "oc-if:base-interface-ref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=True)""",
        })
...
also known as the Port Priority
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'name': name, 'cost': cost, 'port_priority': port_priority, }
...
class yc_counters_openconfig_spanning_tree__stp_rstp_interfaces_interface_state_counters(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__bpdu_sent','__bpdu_received',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rstp', u'interfaces', u'interface', u'state', u'counters']
  ...
  _pyangbind_elements = {'bpdu_sent': bpdu_sent, 'bpdu_received': bpdu_received, }
...
class yc_state_openconfig_spanning_tree__stp_rstp_interfaces_interface_state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__designated_port_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="designated-port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=False)
    self.__name = YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=False)
    self.__port_state = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="port-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)
    self.__designated_bridge_address = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    self.__designated_bridge_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="designated-bridge-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=False)
    ...
    self.__cost = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..200000000']}), is_leaf=True, yang_name="cost", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint32', is_config=False)
    self.__role = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="role", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rstp', u'interfaces', u'interface', u'state']
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with oc-if:base-interface-ref""",
          'defined-type': "oc-if:base-interface-ref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=False)""",
        })
...
also known as the Port Priority
  ...
  def _set_role(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="role", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """role must be of a type compatible with identityref""",
          'defined-type': "openconfig-spanning-tree:identityref",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BACKUP': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ALTERNATE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DESIGNATED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:ROOT': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="role", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)""",
        })
  ...
  def _set_port_state(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="port-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """port_state must be of a type compatible with identityref""",
          'defined-type': "openconfig-spanning-tree:identityref",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'LISTENING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:DISABLED': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'FORWARDING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'BLOCKING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:LEARNING': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="port-state", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=False)""",
        })
...
to be the designated bridge for this port's segment.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """designated_bridge_address must be of a type compatible with oc-yang:mac-address""",
          'defined-type': "oc-yang:mac-address",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^[0-9a-fA-F]{2}(:[0-9a-fA-F]{2}){5}$'}), is_leaf=True, yang_name="designated-bridge-address", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-yang:mac-address', is_config=False)""",
        })
...
Bridge for this port's segment, two octet string
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="designated-port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """designated_port_priority must be of a type compatible with oc-stp-types:stp-port-priority-type""",
          'defined-type': "oc-stp-types:stp-port-priority-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..240']}), is_leaf=True, yang_name="designated-port-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-port-priority-type', is_config=False)""",
        })
...
class yc_interface_openconfig_spanning_tree__stp_rstp_interfaces_interface(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rstp', u'interfaces', u'interface']
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)""",
        })
...
class yc_interfaces_openconfig_spanning_tree__stp_rstp_interfaces(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rstp', u'interfaces']
...
data
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__interfaces',)
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'interfaces': interfaces, }
...
class yc_config_openconfig_spanning_tree__stp_mstp_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__revision','__max_hop','__hello_time','__max_age','__forwarding_delay','__hold_count',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__max_age = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'6..40']}), is_leaf=True, yang_name="max-age", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__name = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..32']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='string', is_config=True)
    self.__hello_time = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), is_leaf=True, yang_name="hello-time", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__hold_count = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..10']}), default=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8)(6), is_leaf=True, yang_name="hold-count", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__forwarding_delay = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'4..30']}), is_leaf=True, yang_name="forwarding-delay", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    self.__max_hop = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..255']}), is_leaf=True, yang_name="max-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
  ...
  def _set_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..32']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """name must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_dict={'length': [u'1..32']}), is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='string', is_config=True)""",
        })
...
region that a BPDU can traverse before it is discarded
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..255']}), is_leaf=True, yang_name="max-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """max_hop must be of a type compatible with uint8""",
          'defined-type': "uint8",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..255']}, int_size=8), restriction_dict={'range': [u'1..255']}), is_leaf=True, yang_name="max-hop", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint8', is_config=True)""",
        })
...
switch can send from an interface
  ...
  _pyangbind_elements = {'name': name, 'revision': revision, 'max_hop': max_hop, 'hello_time': hello_time, 'max_age': max_age, 'forwarding_delay': forwarding_delay, 'hold_count': hold_count, }
...
class yc_config_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mst_id','__vlan','__bridge_priority',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__bridge_priority = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), restriction_dict={'range': [u'1..611440']}), is_leaf=True, yang_name="bridge-priority", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-bridge-priority-type', is_config=True)
    self.__vlan = YANGDynClass(base=TypedListType(allowed_type=[RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1..4094']}),RestrictedClassType(base_type=unicode, restriction_dict={'pattern': u'^(409[0-4]|40[0-8][0-9]|[1-3][0-9]{3}|[1-9][0-9]{1,2}|[1-9])\\.\\.(409[0-4]|40[0-8][0-9]|[1-3][0-9]{3}|[1-9][0-9]{1,2}|[1-9])$'}),]), is_leaf=False, yang_name="vlan", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='union', is_config=True)
    self.__mst_id = YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1..4094']}), is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint16', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'config']
...
a spanning tree (or MST) instance.
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1..4094']}), is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint16', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mst_id must be of a type compatible with uint16""",
          'defined-type': "uint16",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), restriction_dict={'range': [u'1..4094']}), is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='uint16', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'mst_id': mst_id, 'vlan': vlan, 'bridge_priority': bridge_priority, }
...
class yc_state_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mst_id','__vlan','__bridge_priority','__bridge_address','__designated_root_priority','__designated_root_address','__root_port','__root_cost','__hold_time','__topology_changes','__time_since_topology_change',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'state']
...
reset or initialized
  ...
  def _get_time_since_topology_change(self):
    """
    Getter method for time_since_topology_change, mapped from YANG variable /stp/mstp/mst_instances/mst_instance/state/time_since_topology_change (oc-types:timeticks64)
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  def _set_time_since_topology_change(self, v, load=False):
    """
    Setter method for time_since_topology_change, mapped from YANG variable /stp/mstp/mst_instances/mst_instance/state/time_since_topology_change (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_time_since_topology_change is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_time_since_topology_change() directly.
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  _pyangbind_elements = {'mst_id': mst_id, 'vlan': vlan, 'bridge_priority': bridge_priority, 'bridge_address': bridge_address, 'designated_root_priority': designated_root_priority, 'designated_root_address': designated_root_address, 'root_port': root_port, 'root_cost': root_cost, 'hold_time': hold_time, 'topology_changes': topology_changes, 'time_since_topology_change': time_since_topology_change, }
...
class yc_config_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_interfaces_interface_config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'interfaces', u'interface', u'config']
...
class yc_counters_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_interfaces_interface_state_counters(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'interfaces', u'interface', u'state', u'counters']
...
class yc_state_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_interfaces_interface_state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'interfaces', u'interface', u'state']
...
class yc_interface_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_interfaces_interface(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'interfaces', u'interface']
...
class yc_interfaces_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance_interfaces(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance', u'interfaces']
...
class yc_mst_instance_openconfig_spanning_tree__stp_mstp_mst_instances_mst_instance(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mst_id','__config','__state','__interfaces',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__mst_id = YANGDynClass(base=unicode, is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances', u'mst-instance']
  ...
  def _set_mst_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """mst_id must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="mst-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'mst_id': mst_id, 'config': config, 'state': state, 'interfaces': interfaces, }
...
class yc_mst_instances_openconfig_spanning_tree__stp_mstp_mst_instances(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mst_instance',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'mstp', u'mst-instances']
  ...
  _pyangbind_elements = {'mst_instance': mst_instance, }
...
data
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__mst_instances',)
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'mst_instances': mst_instances, }
...
class yc_config_openconfig_spanning_tree__stp_rapid_pvst_vlan_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan_id','__hello_time','__max_age','__forwarding_delay','__hold_count','__bridge_priority',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'config']
...
switch can send from an interface
  ...
  _pyangbind_elements = {'vlan_id': vlan_id, 'hello_time': hello_time, 'max_age': max_age, 'forwarding_delay': forwarding_delay, 'hold_count': hold_count, 'bridge_priority': bridge_priority, }
...
class yc_state_openconfig_spanning_tree__stp_rapid_pvst_vlan_state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan_id','__hello_time','__max_age','__forwarding_delay','__hold_count','__bridge_priority','__bridge_address','__designated_root_priority','__designated_root_address','__root_port','__root_cost','__hold_time','__topology_changes','__time_since_topology_change',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'state']
...
reset or initialized
  ...
  def _get_time_since_topology_change(self):
    """
    Getter method for time_since_topology_change, mapped from YANG variable /stp/rapid_pvst/vlan/state/time_since_topology_change (oc-types:timeticks64)
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  def _set_time_since_topology_change(self, v, load=False):
    """
    Setter method for time_since_topology_change, mapped from YANG variable /stp/rapid_pvst/vlan/state/time_since_topology_change (oc-types:timeticks64)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_time_since_topology_change is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_time_since_topology_change() directly.
...
the Unix Epoch (Jan 1, 1970 00:00:00 UTC).
  ...
  _pyangbind_elements = {'vlan_id': vlan_id, 'hello_time': hello_time, 'max_age': max_age, 'forwarding_delay': forwarding_delay, 'hold_count': hold_count, 'bridge_priority': bridge_priority, 'bridge_address': bridge_address, 'designated_root_priority': designated_root_priority, 'designated_root_address': designated_root_address, 'root_port': root_port, 'root_cost': root_cost, 'hold_time': hold_time, 'topology_changes': topology_changes, 'time_since_topology_change': time_since_topology_change, }
...
class yc_config_openconfig_spanning_tree__stp_rapid_pvst_vlan_interfaces_interface_config(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'interfaces', u'interface', u'config']
...
class yc_counters_openconfig_spanning_tree__stp_rapid_pvst_vlan_interfaces_interface_state_counters(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'interfaces', u'interface', u'state', u'counters']
...
class yc_state_openconfig_spanning_tree__stp_rapid_pvst_vlan_interfaces_interface_state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'interfaces', u'interface', u'state']
...
class yc_interface_openconfig_spanning_tree__stp_rapid_pvst_vlan_interfaces_interface(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'interfaces', u'interface']
...
class yc_interfaces_openconfig_spanning_tree__stp_rapid_pvst_vlan_interfaces(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan', u'interfaces']
...
class yc_vlan_openconfig_spanning_tree__stp_rapid_pvst_vlan(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__vlan_id','__config','__state','__interfaces',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__vlan_id = YANGDynClass(base=unicode, is_leaf=True, yang_name="vlan-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'rapid-pvst', u'vlan']
  ...
  def _set_vlan_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=unicode, is_leaf=True, yang_name="vlan-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """vlan_id must be of a type compatible with leafref""",
          'defined-type': "leafref",
          'generated-type': """YANGDynClass(base=unicode, is_leaf=True, yang_name="vlan-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='leafref', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'vlan_id': vlan_id, 'config': config, 'state': state, 'interfaces': interfaces, }
...
class yc_config_openconfig_spanning_tree__stp_interfaces_interface_config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__edge_port','__link_type','__guard','__bpdu_guard','__bpdu_filter',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__name = YANGDynClass(base=unicode, is_leaf=True, yang_name="name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-if:base-interface-ref', is_config=True)
    self.__bpdu_guard = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="bpdu-guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='boolean', is_config=True)
    self.__guard = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'NONE': {}, u'ROOT': {}, u'LOOP': {}},), is_leaf=True, yang_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-guard-type', is_config=True)
    self.__bpdu_filter = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="bpdu-filter", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='boolean', is_config=True)
    self.__edge_port = YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="edge-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=True)
    self.__link_type = YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'SHARED': {}, u'P2P': {}},), is_leaf=True, yang_name="link-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-link-type', is_config=True)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'interfaces', u'interface', u'config']
  ...
  def _set_edge_port(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="edge-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """edge_port must be of a type compatible with identityref""",
          'defined-type': "openconfig-spanning-tree:identityref",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode, restriction_type="dict_key", restriction_arg={u'oc-stp-types:EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_AUTO': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_ENABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}, u'oc-stp-types:EDGE_DISABLE': {'@namespace': u'http://openconfig.net/yang/spanning-tree/types', '@module': u'openconfig-spanning-tree-types'}},), is_leaf=True, yang_name="edge-port", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='identityref', is_config=True)""",
        })
  ...
  def _set_link_type(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'SHARED': {}, u'P2P': {}},), is_leaf=True, yang_name="link-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-link-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          ...
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'SHARED': {}, u'P2P': {}},), is_leaf=True, yang_name="link-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-link-type', is_config=True)""",
        })
  ...
  def _set_guard(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'NONE': {}, u'ROOT': {}, u'LOOP': {}},), is_leaf=True, yang_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-guard-type', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """guard must be of a type compatible with oc-stp-types:stp-guard-type""",
          'defined-type': "oc-stp-types:stp-guard-type",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=unicode,                                     restriction_type="dict_key",                                     restriction_arg={u'NONE': {}, u'ROOT': {}, u'LOOP': {}},), is_leaf=True, yang_name="guard", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/spanning-tree', defining_module='openconfig-spanning-tree', yang_type='oc-stp-types:stp-guard-type', is_config=True)""",
        })
  ...
  _pyangbind_elements = {'name': name, 'edge_port': edge_port, 'link_type': link_type, 'guard': guard, 'bpdu_guard': bpdu_guard, 'bpdu_filter': bpdu_filter, }
...
class yc_state_openconfig_spanning_tree__stp_interfaces_interface_state(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'interfaces', u'interface', u'state']
...
class yc_interface_openconfig_spanning_tree__stp_interfaces_interface(PybindBase):
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'stp', u'interfaces', u'interface']
...
state data
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__global_','__rstp','__mstp','__rapid_pvst','__interfaces',)
...
operational data
  ...
  _pyangbind_elements = {'global_': global_, 'rstp': rstp, 'mstp': mstp, 'rapid_pvst': rapid_pvst, 'interfaces': interfaces, }
...
for the spanning tree protocol.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__stp',)
